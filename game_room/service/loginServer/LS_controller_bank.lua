...
local REQUEST = {
	[0x000700] = function(tcpAgent, pbObj, tcpAgentData)
		...
		-- 	return 0x000700, {code="RC_OK", score=score, insure=insure}
	...
	[0x000701] = function(tcpAgent, pbObj, tcpAgentData)
		...
		-- 	if attr.serverID~=0 then
		-- 		skynet.send(addressResolver.getAddressByServiceName("LS_model_serverManager"), "lua", "gs_info", attr.serverID, 
		-- 			COMMON_CONST.LSNOTIFY_EVENT.EVT_LSNOTIFY_USER_BANK, {userID=tcpAgentData.userID, score=pbObj.amount, insure=-pbObj.amount})
		-- 	end		
