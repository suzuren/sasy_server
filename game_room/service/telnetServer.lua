...
function COMMAND.help()
	return {
		...
		user = "list all user",
		kick = "kick user",
		reloadTableFrameConfig = "reload tableFrameSink fish config",
	}
end
--[[
...
function COMMAND.reloadTableFrameConfig()
	skynet.send(addressResolver.getAddressByServiceName("GS_model_tableManager"), "lua", "reloadTableFrameConfig")
end	
